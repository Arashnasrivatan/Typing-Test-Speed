...
const lans = [
    ...
    [
        ...
        `<?php $num = 1 + 1; echo $num; ?>`,
        `<?php echo date("Y-m-d H:i:s"); ?>`,
        `<?php $arr = [1, 2, 3]; foreach ($arr as $num) { echo $num; } ?>`,
        `<?php function add($a, $b) { return $a + $b; } echo add(2, 3); ?>`,
        `<?php $str = "Hello"; echo strtoupper($str); ?>`,
        `<?php $str = "HELLO"; echo strtolower($str); ?>`,
        `<?php $str = "Hello World"; echo substr($str, 0, 5); ?>`,
        `<?php $arr = ["a" => 1, "b" => 2]; echo $arr["a"]; ?>`,
        `<?php $json = '{"a":1,"b":2}'; $obj = json_decode($json); echo $obj->a; ?>`
    ],
    // Python codes
    [
